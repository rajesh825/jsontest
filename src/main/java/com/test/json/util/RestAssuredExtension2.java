...
public class RestAssuredExtension2 {
    ...
    */
/**
     * RestAssuredExtension2 constructor to pass the initial settings for the the following method
     * @param uri
     * @param method
     * @param token
     *//*
...
/*  public RestAssuredExtension2(String uri, String method, String token) {
    ...
    public RestAssuredExtension2(String uri, String method) {

        //Formulate the API url
        this.url = "https://jsonplaceholder.typicode.com" + uri;
        this.method = method;
    }
